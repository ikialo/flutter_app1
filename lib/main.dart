        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
              ...
              appBar: AppBar(elevation:10,
                ...
                bottom : TabBar(indicatorColor: Colors.deepPurpleAccent ,
                  labelColor: Colors.deepPurple,
                  tabs: [
                    Tab(child: Text("Balance",
                      style: TextStyle(fontWeight: FontWeight.bold),
                    ),),
                    Tab(child: Text("Transfer", style: TextStyle(fontWeight: FontWeight.bold),),),
                    Tab(child: Text("Top Up", style: TextStyle(fontWeight: FontWeight.bold),),),
                  ],
                ),
                title: Text("BSP USSD",
